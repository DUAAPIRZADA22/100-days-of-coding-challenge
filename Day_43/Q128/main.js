"use strict";
// Create an arrow function that takes multiple parameters and returns the product 
//of all parameters.
const multipleParameters = (...numbers) => numbers.reduce((total, number) => total * number, 1); // 1 is initial value
